...
const ChooseUs = () => {
    return (
        <div className="container mx-auto">
            ...
            <p className="text-base md:text-lg lg:text-neutral-500 pb-2">WHY CHOOSE US</p>
            <h1 className="max-w-md text-4xl mx-auto font-semibold mb-10">Long-term vision and grow your business</h1>
