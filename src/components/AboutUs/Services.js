...
const Services = () => {
    return (
        <div className="container mx-auto">
            ...
            <p className="text-base md:text-lg lg:text-neutral-500 mb-3">SERVICES</p>
            <h1 className="max-w-md text-4xl mx-auto font-semibold mb-10">We provide high quality services</h1>
